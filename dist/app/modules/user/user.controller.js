...
exports.getMe = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.default.findById(userId).populate('followers following', 'name email profilePic isVerified');
...
exports.createUser = request.createOne(user_model_1.default);
exports.getUser = request.getOne(user_model_1.default);
exports.getAllUsers = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let query = user_model_1.default.find({ isDeleted: false });
...
exports.updateUser = request.updateOne(user_model_1.default);
exports.deleteUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.params.id;
    const user = yield user_model_1.default.findByIdAndUpdate(userId, { isDeleted: true }, { new: true, runValidators: true });
    if (!user) {
